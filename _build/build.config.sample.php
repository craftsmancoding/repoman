 ...
 */
/**
 * If you are contributing to this package, clone the Git repo to a location
 * somewhere inside your MODX web root, then define the MODX path constants
 * necessary for core installation and rename this file to "build.config.php"
 */
