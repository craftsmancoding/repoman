 ...
 *      "$object" even though it's an array. This is a good place for you to read custom configuration options
 *      like the a minimum PHP version (see the below example).
 *
